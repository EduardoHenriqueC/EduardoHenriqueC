...
🎨 Combino conhecimentos de UI/UX Design (prototipagem e heurísticas de navegabilidade) com desenvolvimento para criar interfaces intuitivas.
...
Bancos de Dados & Arquitetura: SQL (SQLite / PostgreSQL) | Modelagem DER
...
🏫 Desafios Acadêmicos: Resolução rigorosa das atividades e algoritmos propostos na faculdade.

🧪 Projetos Autorais: Criação contínua de protótipos e pequenos sistemas para aplicar novos conceitos de programação e arquitetura de software na prática.